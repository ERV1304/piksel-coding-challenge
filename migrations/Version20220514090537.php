...
final class Version20220514090537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE episode (id VARCHAR(35) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rightsowner (id INT AUTO_INCREMENT NOT NULL, episode_id VARCHAR(255) NOT NULL, studio_id VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_47E4B831362B62A0 (episode_id), INDEX IDX_47E4B831446F285F (studio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE royalty (id INT AUTO_INCREMENT NOT NULL, studio_id VARCHAR(255) NOT NULL, payment DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_4B26F605446F285F (studio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE studio (id VARCHAR(35) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE viewing (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, episode_id VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_F5BB46989395C3F3 (customer_id), INDEX IDX_F5BB4698362B62A0 (episode_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
